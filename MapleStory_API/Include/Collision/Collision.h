...
public:
	...
	static bool CollisionSphereToBox(class CColliderSphere* Src, class CColliderBox* Dest);
	static bool CollisionSphereToBox(const SphereInfo& Src, const RectInfo& Dest);
};
